...
class AuthController(
    ...
    @Operation(summary = "구글 OAuth 콜백 — JWT 발급")
    @GetMapping("/google/callback")
    fun googleCallback(@RequestParam code: String): ResponseEntity<TokenResponse> {
